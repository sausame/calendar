...
public class EditDailyStatusView implements View.OnClickListener, DialogInterface.OnCancelListener,
    ...
    private void showTimezoneDialog() {
        ...
        tzpd.setArguments(b);
        tzpd.setOnTimeZoneSetListener(EditDailyStatusView.this);
    ...
    public void onClick(View view) {
        if (view == mRruleButton) {
            ...
            rpd.setArguments(b);
            rpd.setOnRecurrenceSetListener(EditDailyStatusView.this);
    ...
    private boolean fillModelFromUI() {
        ...
        if (mModel.mUri == null) {
            ...
            if (mCalendarsCursor.moveToPosition(calendarCursorPosition)) {
                String defaultCalendar = mCalendarsCursor.getString(
                        EditDailyStatusHelper.CALENDARS_INDEX_OWNER_ACCOUNT);
                ...
                mModel.mCalendarId = mCalendarsCursor.getLong(EditDailyStatusHelper.CALENDARS_INDEX_ID);
            }
        }
        ...
        // event.
        if (mModification == EditDailyStatusHelper.MODIFY_SELECTED) {
            mModel.mRrule = null;
        } else {
    ...
    public EditDailyStatusView(Activity activity, View view, EditDoneRunnable done,
    ...
    public void setModel(CalendarEventModel model) {
        ...
        boolean canRespond = EditDailyStatusHelper.canRespond(model);
    ...
    private void setViewStates(int mode) {
        ...
        if (mode == Utils.MODIFY_UNINITIALIZED || !EditDailyStatusHelper.canModifyEvent(mModel)) {
            setWhenString();
            ...
            if (EditDailyStatusHelper.canAddReminders(mModel)) {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        mModel.mCalendarAccountName = c.getString(EditDailyStatusHelper.CALENDARS_INDEX_ACCOUNT_NAME);
        mModel.mCalendarAccountType = c.getString(EditDailyStatusHelper.CALENDARS_INDEX_ACCOUNT_TYPE);
    ...
    private void updateHomeTime() {
        ...
        if (!mAllDayCheckBox.isChecked() && !TextUtils.equals(tz, mTimezone)
                && mModification != EditDailyStatusHelper.MODIFY_UNINITIALIZED) {
            int flags = DateUtils.FORMAT_SHOW_TIME;
